...
RSpec.describe AddressBook do
  ...
  describe "#import_from_csv" do
    ...
    it "imports the 2nd entry" do
       ...
       check_entry(entry_two, "Jochen", "04123456", "my.mail@mail.com")
     end
  ...
  describe "#binary_search" do
    ...
    it "searches AddressBook for Jochen" do
      book.import_from_csv("entries.csv")
      entry = book.binary_search("Jochen")
      expect(entry).to be_a Entry
      check_entry(entry, "Jochen","04123456","my.mail@mail.com")
    end
    ...
    it "searches AddressBook for Bobby" do
      book.import_from_csv("entries.csv")
      entry = book.binary_search("Bobby")
      expect(entry).to be_nil
    end
  end
  describe "#iterative_search" do
    ...
    it "searches AddressBook for Jochen" do
      book.import_from_csv("entries.csv")
      entry = book.iterative_search("Jochen")
      expect(entry).to be_a Entry
      check_entry(entry, "Jochen","04123456","my.mail@mail.com")
    end
    it "searches AddressBook for Bob" do
    ...
    it "searches AddressBook for Bobby" do
      book.import_from_csv("entries.csv")
      entry = book.iterative_search("Bobby")
      expect(entry).to be_nil
    end
  end
end
